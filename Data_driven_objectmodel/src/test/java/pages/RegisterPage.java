...
public class RegisterPage extends Base_page{
	...
	public void insert_phone_number(String phone_no)
	{
		wait_elements(base_page_driver,20,phone_number);
		base_page_driver.findElement(phone_number).clear();
		base_page_driver.findElement(phone_number). sendKeys (phone_no);
	}
	...
	public void confirm_password(String cpss)
	{
		wait_elements(base_page_driver,20,confirm_password);
		base_page_driver.findElement(confirm_password).clear();
		base_page_driver.findElement(confirm_password).sendKeys(cpss);
	}
